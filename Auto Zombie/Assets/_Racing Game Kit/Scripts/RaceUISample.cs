...
/// </summary>
[AddComponentMenu("Racing Game Kit/UI/Race UI Sample"), RequireComponent(typeof(Race_Manager))]
public class RaceUISample : MonoBehaviour, IRGKUI
   {
        ...
        void OnGUI()
        {
            ...
            {
                windowPlacement = GUI.Window(0, windowPlacement, RenderPlacementWindow, "", "PlacementWindowStyle");
            }
            if (_ShowTimeWindow)
            {
            ...
            {
                windowCountdownCharacter = GUI.Window(3, windowCountdownCharacter, RenderCountdownWindow, "", "CountDownWindowStyle");
            }
            if (_ShowImageCountdown)
            {
                windowCountdownImage = GUI.Window(3, windowCountdownImage, RenderCountDownWindowImages, "", "TransparentWindow");
            }
            ...
            if (_ShowResults)
            {
                windowResults = GUI.Window(4, windowResults, RenderResultsWindow, "RACE RESULTS", "ResultsWindowStyle");
            }
